...
RUN apk add --upgrade --update --no-cache \
    ...
    mkdir -p /etc/ingress-controller/auth /etc/ingress-controller/ssl /etc/ingress-controller/geoip /etc/ingress-controller/telemetry && chmod 755 /etc/ingress-controller/auth /etc/ingress-controller/ssl /etc/ingress-controller/geoip /etc/ingress-controller/telemetry && \
